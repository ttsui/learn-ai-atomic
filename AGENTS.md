...
The `/init` command produces generic, bloated files. Your `AGENTS.md` affects **every single artifact** Claude produces—it's the highest leverage point of the entire harness.
